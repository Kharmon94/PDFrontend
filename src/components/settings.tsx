...
import { ArrowLeft, User, Bell, Shield, Palette, Globe, CreditCard, Trash2 } from 'lucide-react';
...
export function Settings({ onBack, userName, userEmail, isDarkMode, onToggleTheme }: SettingsProps) {
